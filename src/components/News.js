...
export class News extends Component {
  ...
  async updateNews () {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=5a4e1168138a4b08b1048c60fdf593a4&page=${this.state.page}&pageSize=${this.props.pageSize}`;
